...
// Corrected SQL query
$sql = "SELECT * FROM products"; // Use "FROM" instead of "FORM"
...
<div class="container-fluid" style="padding-top: 15px;">
    <div class="d-flex justify-content-start">
        <a href="new_product.php"><button class="btn btn-primary" style="width: 150px; height: 40px;"><i class="fa-solid fa-arrow-left"></i> Back</button></a>
    </div>
</div>
